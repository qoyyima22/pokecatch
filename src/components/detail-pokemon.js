    ...
    return (
        ...
        `}>
            ...
            <Modal show={isModal} close={() => setModal(false)} closable={!isCatched}>
                <ModalContent close={() => setModal(false)} name={data?.name} isCatched={isCatched} owned={owned} setOwned={setOwned} setIsCatched={setIsCatching} />
            </Modal>
        </div>
    )
}
    ...
    return (
        <img css={css`
            ...
            @keyframes throw {
                ...
                9.1724% { transform: translate(-6.26vw, -44.0px) scale(0.9) rotate(20deg); ; }
                17.5620% { transform: translate(-11.146vw, -85.8px) scale(0.85) rotate(40deg); ; }
                25.2440% { transform: translate(-14.746vw, -125.4px) scale(0.8) rotate(60deg); ; }
                32.2993% { transform: translate(-17.12vw, -162.7px) scale(0.75) rotate(80deg); ; }
                38.8154% { transform: translate(-18.32vw, -197.9px) scale(0.7) rotate(100deg); ; }
                44.8856% { transform: translate(-18.64vw, -230.9px) scale(0.65) rotate(120deg); ; }
                50.6076% { transform: translate(-17.413vw, -261.8px) scale(0.6) rotate(140deg); ; }
                56.0800% { transform: translate(-15.44vw, -290.6px) scale(0.55) rotate(160deg); ; }
                61.3985% { transform: translate(-12.5vw, -317.4px) scale(0.5) rotate(180deg); ; }
                66.6510% { transform: translate(-8.693vw, -342.2px) scale(0.45) rotate(200deg); ; }
                71.9130% { transform: translate(-4.08vw, -364.9px) scale(0.40) rotate(220deg); ; }
                77.2461% { transform: translate(1.306vw, -385.7px) scale(0.35) rotate(240deg); ; }
                82.6960% { transform: translate(7.413vw, -404.6px) scale(0.33) rotate(260deg); ; }
                88.2944% { transform: translate(14.13vw, -421.6px) scale(0.33) rotate(280deg); ; }
                94.0598% { transform: translate(21.46vw, -436.7px) scale(0.33) rotate(300deg); ; }
                100.0000% { transform: translate(29.3vw, -450.0px) scale(0.33) rotate(320deg); }
            }
...
const ModalContent = ({isCatched, name, setOwned, owned, setIsCatched, close}) => {
    const [nick, setNick] = React.useState('')
    const save = () => {
        let temp = [...owned, {name, nick}]
